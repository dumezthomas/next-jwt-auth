    ...
    <div className="flex h-screen justify-center items-center">
      ...
      {token.length === 0 && (
        <div className="auth-form flex flex-col gap-5">
          <h1 className="text-2xl">Enter your email to receive reset password link</h1>
          <hr />
          ...
          <button className={email.length === 0 ? "disabled-btn" : ""} onClick={sendEmail}>
      ...
      {token.length > 0 && (
        <div className="auth-form flex flex-col gap-5">
          <h1 className="text-2xl">Enter your new password and confirm password</h1>
          <hr />
          ...
          <Input
            ...
            error={confirmPassword.length === 0 ? "Confirm Password is required" : ""}
